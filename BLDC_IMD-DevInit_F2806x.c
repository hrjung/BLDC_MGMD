...
//============================================================================
//
// FILE:	BLDC_Sensored-DevInit_F2806x.c
//
...
// Refer to the datasheet for your particular device. 
   ...
   //------------------------------------------------
	#if(0) // 2017.02.27 SJeong
   SysCtrlRegs.PCLKCR3.bit.GPIOINENCLK = 0;	//SYSCLKOUT on GPIO
	#else
   SysCtrlRegs.PCLKCR3.bit.USB0ENCLK = 0;	//SYSCLKOUT on GPIO
	#endif
   //------------------------------------------------
...
//  GPIO-13 - PIN FUNCTION = TZ-OTWn
	GpioCtrlRegs.GPAMUX1.bit.GPIO13 = 1;	// 0=GPIO,  1=TZ2,  2=Resv,  3=SPISOMIB
