...
#define PWMDAC_INIT_MACRO_IMD(v)										\
																	\
    /* Setup Sync*/													\
    ...
    /* Setting 6A & 6B EPWMs as DAC output pins*/					\
																	\
    GpioCtrlRegs.GPAMUX1.bit.GPIO12 = 1;     /* EPWM5A pin*/			\
    GpioCtrlRegs.GPAMUX1.bit.GPIO13 = 1;    /* EPWM6A pin*/			\
    GpioCtrlRegs.GPAMUX1.bit.GPIO14 = 1;    /* EPWM6B pin*/			\
      																\
    EDIS;                             /* Disable EALLOW*/
